...
void compute(void *arg)
{
		...
		while(1)
		{
			...
			accounts=a->acc;
			int curr_amt1=accounts[(a->a1)[ctr1]-1001];
			int curr_amt2=accounts[(a->a2)[ctr1]-1001];
			int value=(a->m)[ctr1];
			switch((a->type)[ctr1])
			{
				case 1:  accounts[(a->a1)[ctr1]-1001]=curr_amt1+0.99*value;
				     break;
				case 2:  accounts[(a->a1)[ctr1]-1001]=curr_amt1-1.01*value;
				     break;
				case 3:  accounts[(a->a1)[ctr1]-1001]=1.071*curr_amt1;
				     break;
				case 4:  accounts[(a->a1)[ctr1]-1001]=curr_amt1-1.01*value;
        			 	 accounts[(a->a2)[ctr1]-1001]=curr_amt2+0.99*value;
